...
打破规矩的后果：如果在 SCL 为高电平时，SDA 没稳住发生了跳变，接收方就会误把这个跳变当成上面的“启动”或“停止”信号，导致整场通信直接崩溃乱套。
...
设备地址：从设备地址用来区分总线上不同的从设备，**一般发送从设备地址的时候会在最低位加上读/写信号，比如设备地址为0x50，0表示读，1表示写，则读数据就会发送0xA0，写数据就会发送0xA1。**
